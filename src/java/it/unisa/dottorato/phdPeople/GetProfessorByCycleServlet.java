 ...
 */
@WebServlet(name = "GetProfessorByCycle", urlPatterns = {"/dottorato/GetProfessorByCycle"})
public class GetProfessorByCycleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ArrayList<Person> professors = PhdPeopleManager.getInstance().getProfessorByCycle(phdCycleId);
