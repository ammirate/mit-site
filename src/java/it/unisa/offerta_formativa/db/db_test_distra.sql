...
--
-- Database: `db_test_distra`
--
CREATE DATABASE IF NOT EXISTS `db_test_distra` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `db_test_distra`;
...
('c.bianchi@studenti.unisa.it', '0000', 'student', 1),
('m.rossi@unisa.it', '0000', 'professor', 1);
...
('Tecnologie Informatiche e Management', '02225P0001', '02225', 1);
...
('Tecnologie Informatiche e Management', '02225', 'https://esse3web.unisa.it/unisa/Guide/PaginaFacolta.do?fac_id=500082', 'DISTRA', 2, 1);
...
('DISTRA', 'Dipartimento Studi e ricerche aziendali', 'www.moodle-distra.it', 'scdeatvtgrecgtesrgesc');
...
('0222500002', 'IT Project & Service Management', 'ITPSM', 'https://esse3web.unisa.it/unisa/Guide/PaginaADErogata.do%3Bjsessionid=1D2791780BCFEE214D37B2AC76DDFD8F.jvm1?ad_er_id=2014*N0*N0*S1*39751*509790&ANNO_ACCADEMICO=2014&mostra_percorsi=N', 1, 1, 1, 'bla bla blaaaaaaaaaaaaaaaaa');
