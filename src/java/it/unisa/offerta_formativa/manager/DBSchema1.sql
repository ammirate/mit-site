...
`CurriculumVitaePATH` VARCHAR(45) NULL,
`AccademicTranscriptPATH` VARCHAR(45) NULL,
...
`FK_SerialNum` VARCHAR(45) NOT NULL,
...
INDEX `fk_Student_StudentAttendence1_idx` (`FK_SerialNum` ASC),
...
ON DELETE NO ACTION
ON UPDATE NO ACTION,
CONSTRAINT `fk_Student_StudentAttendence1`
FOREIGN KEY (`FK_SerialNum`)
REFERENCES `mydb`.`StudentAttendence` (`SerialNum`)
ON DELETE NO ACTION
ON UPDATE NO ACTION,
