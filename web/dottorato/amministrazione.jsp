                        ...
                        <div class="panel-body">
                            ...
                            <form id="cycle_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input list="professorCycleList" id="phdCycleProfessor" class="form-control" name="professor" placeholder="Inserisci il coordinatore del ciclo" required>
                                        <datalist id="professorCycleList">

                                        </datalist>
                                    </div>
                                    <p class="text-info"> Selezionare un professore dalla lista. </p>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form id="curriculum_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input list="professorCurriculumList" id="phdCurriculumProfessor" class="form-control" name="professor" placeholder="Inserisci il coordinatore del curriculum" required>
                                ...
                                <!-- Pulsanti di invio e reset del form -->
                                <div class="form-group">
                                    <input type="submit" id="submitPhdCurriculum" class="btn btn-blue" value="Invia"> 
                        ...
                        <div class="panel-body">
                            ...
                            <form id="phdUser_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-info"> Selezionare uno studente dalla lista. </p>
                                </div>
