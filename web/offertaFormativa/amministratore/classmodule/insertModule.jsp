                                    ...
                                    <form action="InsertModuleServlet" method="post" role="form" class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-4" id="classdiv" style="display:none;">
                                                ...
                                                <input type="text" id="modulename" name="modulename" class="form-control" onkeyup="loadAssociation(this.value);" >
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            function loadAssociation(){
                if($("#modulename").val().length===0){
                    ...
                    var options="";
                    var stringa="<div class='lead'>Associa modulo a classi e professori</div><div class='form-group-separator'></div>";
                    ...
                    $.ajax({url:"GetProfessorServlet?department=" + $("#department").val(), success: function (result) {
                        ...
                        $.get('GetClassServlet?matricula='+$("#teaching").val(),function (responseJson) {
