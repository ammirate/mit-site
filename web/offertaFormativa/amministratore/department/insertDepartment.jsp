                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <form id="form1" role="form">
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    <input type="text" class="form-control" id="abbreviation_text" name="matricula" maxlength="50" <% if (department != null) { %> value="<% out.print(department.getAbbreviation());  %>" <% } %>>
                                                </div>

                                                <div class="col-sm-7">
                                                    <label for="title" style="color: black; font-weight: bold" >Titolo:</label>
                                                    <input type="text" id="title_text" maxlength="500" name="titolo" class="form-control" <% if (department != null) { %> value="<% out.print(department.getTitle()); %>" <% } %> > 
                                                </div>
                                            </form>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-11">
                                                ...
                                                <input type="text" id="moodle_url_text" maxlength="1000" class="form-control" name="moodle_url" <% if (department != null) { %> value="<% out.print(department.getUrlMoodle());  %>" <% } %> >
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-11">
                                                ...
                                                <input type="text" id="token_text" maxlength="500" class="form-control" name="link" <% if (department != null) { %> value="<% out.print(department.getToken());  %>" <% }%> >
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-1">
                                                <button type="button" style=" height: 32px; width: 90px; color: black" onclick="InsertDepartment()" id="button_confirm">Conferma</button>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        function InsertDepartment() {
            ...
            if ((validate(abbreviation)) && (validate(token)) && (validate(title)) && (validate(moodle_url))) {
                ...
                if (r == true) {
                    document.location.href = '${pageContext.request.contextPath}/InsertDepartmentServlet?abbreviation=' + abbreviation + '&token=' + token + '&title=' + title + '&url_moodle=' + moodle_url;
                }
            } else {
                var msg;
